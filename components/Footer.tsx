export default function Footer() {
  return (
    <footer className="border-t border-gray-800 bg-[#1a2421] relative z-20">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="/iniciar-sesion" className="bg-[#1a2421] text-white text-center px-8 py-4 rounded-xl font-bold border-2 border-white hover:bg-gray-900 transition-colors text-lg">
              Iniciar Sesión
            </a>
          </div>
        </div>
        <div className="grid md:grid-cols-3 gap-8 pt-8 border-t border-gray-800">
          <div>
            ...
            <p className="text-gray-400 text-sm">Cursos de crianza aceptados por tribunales en todo Estados Unidos.</p>
          </div>
          <div>
