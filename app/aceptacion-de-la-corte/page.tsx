    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="bg-background py-16 md:py-24 border-b border-[#FFFFFF]/10">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-white/70 max-w-3xl mx-auto">Sin importar cómo se llame su corte o por qué está aquí, nuestros certificados son aceptados.</p>
        </div>
      </section>
      ...
      <section className="section-divider py-16 bg-background">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-white/70 mb-8">Las cortes tienen diferentes nombres en diferentes estados. Somos aceptados por todas:</p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {caseTypes.map((item, i) => (
              <div key={i} className="bg-background rounded-xl p-6 border border-[#FFFFFF]/15">
      ...
      <section className="section-divider py-16 bg-background">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-white/70 mb-8">Su certificado incluye todo lo que las cortes necesitan:</p>
          <ul className="space-y-3">
            {certIncludes.map((item, i) => (
              <li key={i} className="flex items-start gap-3">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0 text-[#77DD77]/100" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
                </svg>
                <span className="text-white">{item}</span>
              </li>
