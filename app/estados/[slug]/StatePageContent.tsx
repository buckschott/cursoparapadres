          ...
          <div className="max-w-4xl mx-auto">
            ...
            <details className="scroll-reveal bg-background border-2 border-[#FFFFFF]/15 rounded-xl overflow-hidden group shadow-xl shadow-black/40">
              ...
              <div className="px-6 pb-6 pt-2 border-t border-[#FFFFFF]/10">
                ...
                <div className="mb-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 bg-[#FFFFFF]/5 border border-[#FFFFFF]/15 rounded-lg text-white placeholder-white/40 focus:outline-none focus:border-[#77DD77]/50 focus:ring-1 focus:ring-[#77DD77]/50 transition-colors"
                    />
                    {countySearch && (
                      <button
                ...
                {hasExactMatch && (
                  <div className="mb-4 p-4 bg-[#77DD77]/10 border border-[#77DD77]/30 rounded-lg flex items-center gap-3">
                    <span className="text-[#77DD77] text-2xl">✓</span>
                ...
                {countySearch.trim().length > 0 && filteredCounties.length === 0 && (
                  <div className="mb-4 p-4 bg-[#7EC8E3]/10 border border-[#7EC8E3]/30 rounded-lg">
                    <p className="text-white/70">
                      No encontramos "{countySearch}" — pero nuestra clase es aceptada en <strong className="text-white">todos los {state.countyCount} condados</strong> de {state.nameEs}.
                    </p>
                  </div>
                )}
