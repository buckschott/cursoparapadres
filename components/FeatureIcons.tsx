...
/**
 * Hand-drawn style SVG icons for feature cards.
 * Each icon is designed to work with the stroke-dasharray animation.
 */
...
export function CourtAcceptedIcon({ className = '' }: IconProps) {
  return (
    <svg 
...
export function InstantCertificateIcon({ className = '' }: IconProps) {
  return (
    <svg 
      className={`draw-svg ${className}`}
...
export function ImmediateAccessIcon({ className = '' }: IconProps) {
  return (
    <svg 
      className={`draw-svg ${className}`}
...
export function Access247Icon({ className = '' }: IconProps) {
  return (
    <svg 
      className={`draw-svg ${className}`}
    ...
    >
      ...
      <path d="M571.45,747.58c13.27-24.65,43.46-38.91,70.93-33.50" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="20"/>
      <path d="M421.37,682.08c11.14,50.76,14.54,103.20,10.04,154.97" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="20"/>
